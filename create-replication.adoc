...
[role="lead"]
Crea una relación de replicación para un sistema de archivos FSx para ONTAP en NetApp Workload Factory para evitar la pérdida de datos en caso de un desastre imprevisto. Puedes replicar datos entre dos sistemas de archivos FSx para ONTAP, o entre un sistema ONTAP local y un sistema de archivos FSx para ONTAP.

Para la migración de VM de almacenamiento, completa la operación de transición inmediatamente después de crear una relación de replicación.
...
* link:initialize-replication.html["Inicializar la replicación"] para una nueva relación de replicación.
