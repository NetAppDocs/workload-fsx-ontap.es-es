...
summary: Al habilitar esta función, Workload Factory puede agregar automáticamente almacenamiento incremental a un sistema de archivos FSx para ONTAP a medida que las necesidades de capacidad cambian con el tiempo. 
---
...
[role="lead"]
Al habilitar la administración automática de la capacidad, NetApp Workload Factory permite agregar automáticamente almacenamiento incremental a un sistema de archivos FSx para ONTAP a medida que las necesidades de capacidad cambian con el tiempo.  Además, habilitar esta función elimina la necesidad de monitorear la capacidad manualmente y mitiga el riesgo de lecturas y escrituras de datos de aplicaciones impactantes.
...
* Debe tener credenciales con permisos de _lectura/escritura_ en Workload Factory para completar esta tarea.
