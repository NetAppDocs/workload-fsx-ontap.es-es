...
summary: Descubre cómo gestionar la capacidad de los volúmenes, incluyendo ajustar manualmente el tamaño de los volúmenes y usar el crecimiento automático de volúmenes en Workload Factory. 
---
= Gestiona la capacidad de volumen en NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
La capacidad del volumen debe ajustarse a medida que cambian las necesidades. Puedes ajustar el tamaño del volumen manualmente o activar el crecimiento automático de volúmenes para que Workload Factory gestione la capacidad del volumen por ti. Comprueba el equilibrio de la capacidad de los volúmenes FlexVol o FlexGroup y vuelve a equilibrar la capacidad para distribuir los archivos de manera uniforme entre todos los volúmenes FlexVol de un nodo o entre todos los componentes, de modo que todos los nodos participen en la carga de trabajo de un único volumen FlexGroup.



[[edit-volume-autogrow]]
== Editar el crecimiento automático de volúmenes

Activa la función de crecimiento automático de volúmenes para que Workload Factory gestione la capacidad del volumen por ti. Puedes desactivarla en cualquier momento.


NOTE: No se admite el crecimiento automático de volúmenes para los volúmenes iSCSI.

.Antes de empezar
Para habilitar el crecimiento automático de volúmenes, debes asociar un enlace. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda a asociar un enlace existente o a crear y asociar un nuevo enlace"^]. Una vez asociado el enlace, vuelve a esta operación.
...
. Selecciona el menú de acciones del volumen que quieras modificar.
...
== Ajusta manualmente la capacidad de volumen
...
.Antes de empezar
Para ajustar la capacidad de volumen, debes asociar un enlace. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda a asociar un enlace existente o a crear y asociar un nuevo enlace"^]. Una vez asociado el enlace, vuelve a esta operación.
...
== Reequilibra la capacidad de los volúmenes FlexVol y FlexGroup
...
* Para consultar el saldo de un volumen, debes link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["crear y asociar un enlace o asociar un enlace ya existente al sistema de archivos"^]. Después de que se asocie el enlace, vuelve a esta operación.
...
* Para reequilibrar un volumen, debes link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["crear y asociar un enlace o asociar un enlace ya existente al sistema de archivos"^]. Después de que se asocie el enlace, vuelve a esta operación.
