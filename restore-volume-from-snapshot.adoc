...
---
= Restaurar un volumen a partir de una instantánea en NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
En Workload Factory, puede restaurar datos desde una instantánea a un volumen existente o a un volumen nuevo. La operación de restauración permite la recuperación en un punto determinado del tiempo cuando un volumen contiene archivos eliminados o dañados.
