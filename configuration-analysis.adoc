...
Para un análisis completo del sistema de archivos, debe asociar un enlace.  La conectividad de enlace permite a Workload Factory analizar todas las configuraciones del sistema de archivos, como la protección de datos y el rendimiento.
