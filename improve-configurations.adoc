...
* Fiabilidad: umbral de capacidad de SSD, instantáneas locales programadas, copias de seguridad programadas de volúmenes, replicación de datos remota, fiabilidad de los datos para la retención a largo plazo y conectar hosts al nodo de conmutación por error
...
* Optimización de costes: eficiencias de almacenamiento, organización de datos por niveles, eliminación de instantáneas y copias de seguridad innecesarias, dispositivos de bloque inactivos, capacidad SSD infrautilizada y volúmenes NAS inactivos
* Eficiencia en el rendimiento: conecta los hosts al nodo preferido
