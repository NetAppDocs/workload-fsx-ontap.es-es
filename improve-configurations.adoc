...
* Fiabilidad: umbral de capacidad SSD, instantáneas locales programadas, copias de seguridad de volumen programadas, replicación de datos remota y fiabilidad de los datos para retención a largo plazo
