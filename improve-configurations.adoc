...
* Excelencia operativa: gestión automática de la capacidad, umbral de utilización de la capacidad de archivo de volumen, utilización del volumen cercana al máximo y modo de escritura de la relación de caché
* Optimización de costos: eficiencia de almacenamiento, niveles de datos, eliminación innecesaria de instantáneas y copias de seguridad
...
.Antes de empezar
* Usted debelink:link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["otorgar permisos de _operaciones y remediación_"^] en su cuenta de AWS.
...
. Opcionalmente, filtre los problemas de configuración por categorías, subcategorías, estado, gravedad y etiquetas.
. Seleccione *Ver recomendación* para cualquier configuración.  Asegúrese de revisar la recomendación cuidadosamente.
+
...
. Seleccione el menú image:workloads-menu-icon.png["El ícono del menú de hamburguesa se utiliza para navegar a cargas de trabajo como almacenamiento, eda, ai, bases de datos, vmware y administración."] y luego seleccione *Almacenamiento*.
. En el menú Almacenamiento, seleccione *FSx para ONTAP*.
. Desde *FSx for ONTAP*, seleccione el menú de acciones del sistema de archivos y luego *Administrar*.
. Navegue desde la descripción general del sistema de archivos FSx for ONTAP a la pestaña *Estado de buena arquitectura*.
...
. Seleccione el menú image:workloads-menu-icon.png["El ícono del menú de hamburguesa se utiliza para navegar a cargas de trabajo como almacenamiento, eda, ai, bases de datos, vmware y administración."] y luego seleccione *Almacenamiento*.
. En el menú Almacenamiento, seleccione *FSx para ONTAP*.
. Desde *FSx for ONTAP*, seleccione el actionsenu del sistema de archivos y luego *Administrar*.
. Navegue desde la descripción general del sistema de archivos FSx for ONTAP a la pestaña *Estado de buena arquitectura*.
...
+
** Para un volumen: seleccione actionsenu y luego seleccione *Reactivar volumen*.
