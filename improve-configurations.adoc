...
* Seguridad: Protección autónoma contra ransomware de NetApp con IA (ARP/IA) y acceso no autorizado a volúmenes.
* Excelencia operativa: gestión automática de la capacidad, umbral de utilización de la capacidad del archivo de volumen y utilización del volumen casi al máximo.
* Optimización de costos: eficiencia de almacenamiento, niveles de datos y eliminación innecesaria de instantáneas
* Optimización del rendimiento: reequilibrio de volúmenes de FlexGroup
