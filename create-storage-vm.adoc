...
. Desde *FSx for ONTAP*, seleccione el menú de acciones del sistema de archivos para el cual crear una VM de almacenamiento y seleccione *Crear una VM de almacenamiento*.
