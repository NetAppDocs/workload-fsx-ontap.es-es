...
[role="lead"]
La gestión del recurso compartido CIFS de un volumen en la fábrica de cargas de trabajo BlueXP  incluye la creación de recursos compartidos CIFS, determinar los usuarios y grupos que deben otorgar acceso y el tipo de acceso que les otorga, y la eliminación de los recursos compartidos CIFS.
