...
summary: La administración de un recurso compartido SMB/CIFS de un volumen en Workload Factory incluye la creación, la determinación del acceso de usuarios y grupos, y la eliminación. 
---
= Administrar el recurso compartido SMB/CIFS para un volumen en Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
