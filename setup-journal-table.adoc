...
* Establece la configuración de red en *Internet* para el punto de acceso S3. link:edit-s3-access-point.adoc["Editar la configuración de red del punto de acceso S3"].
...
Si alguno de los pasos falla, <<Troubleshoot the infrastructure setup,solucionar problemas de configuración de la infraestructura para la tabla de registro>> o contacta al soporte de NetApp para obtener ayuda.
