...
.Antes de empezar
Para habilitar ARP/AI en un sistema de archivos o un volumen, debes asociar un enlace. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["Aprenda a asociar un enlace existente o a crear y asociar un nuevo enlace"^]. Una vez asociado el enlace, vuelve a esta operación.
...
. Selecciona el menú de acciones del volumen para activar ARP/AI, luego *Acciones de protección de datos* y después *Gestionar ARP/AI*.
