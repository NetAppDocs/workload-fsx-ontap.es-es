...
+
image:screenshot-reset-fsxadmin-password.png["Una captura de pantalla del menú de tres puntos en la pestaña de información general de un sistema de archivos."]
