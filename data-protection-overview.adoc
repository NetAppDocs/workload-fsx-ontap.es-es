...
keywords: overview 
summary: FSx para ONTAP admite instantáneas, NetApp Autonomous Ransomware con IA, replicación de volumen y copias de seguridad en NetApp Workload Factory. 
---
= Tipos de protección de datos en NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* Utilice la replicación de volumen para la recuperación ante desastres: si su aplicación requiere un RTO bajo, considere usar la replicación de volumen para replicar sus datos en otra región.
