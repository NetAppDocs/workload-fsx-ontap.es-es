...
[role="lead"]
Detener una relación de replicación en la fábrica de cargas de trabajo de BlueXP . Cuando se detiene una relación de replicación, se realiza una actualización programada del volumen de origen al volumen de destino. El volumen objetivo pasará de solo lectura a lectura y escritura.
