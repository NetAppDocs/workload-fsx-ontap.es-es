...
summary: Realice un seguimiento de FSx para ONTAP, las credenciales y las operaciones de enlace y monitoree el progreso del trabajo con Tracker en NetApp Workload Factory for Storage. 
---
= Supervise las operaciones de almacenamiento con Tracker en NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Supervise y realice un seguimiento de la ejecución de FSx para ONTAP, credenciales y operaciones de enlace, y supervise el progreso de las tareas con Tracker en NetApp Workload Factory.
