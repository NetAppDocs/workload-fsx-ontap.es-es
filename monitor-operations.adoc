...
summary: Realiza un seguimiento de las operaciones de carga de trabajo y supervisa el progreso de los trabajos con Tracker en NetApp Workload Factory para FSx para ONTAP. 
---
= Supervisa las operaciones de FSx para ONTAP con Tracker
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
